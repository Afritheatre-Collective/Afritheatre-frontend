      ...
      <div className="flex items-center">
        <div className="flex items-center mr-3">
          <div className="relative w-6 h-6 mr-1">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-[#c14600] rounded-full"></div>
          </div>

          <div className="flex space-x-1">
            <div className="w-2 h-4 bg-[#247373] transform skew-x-12"></div>
            <div className="w-2 h-4 bg-[#c14600] transform -skew-x-12"></div>
            <div className="w-2 h-4 bg-[#247373] transform skew-x-12"></div>
          </div>
        </div>
